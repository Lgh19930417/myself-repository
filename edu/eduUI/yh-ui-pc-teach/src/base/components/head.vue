<template>
  <div>
      ...
      <el-col :span="10" class="userinfo" v-if="this.logined">
        ...
        <div class="nav">
            ...
            <div class="usermenu" >
              ...
              欢迎您：{{user.username}}
              <a href="http://www.lxw.com" target="_blank"><i class="el-icon-star-on"></i>首页</a>
    ...
    <!-- <mt-header fixed title="乘风破浪.乐学程序员Vue商城系统">
    ...
    methods: {
      ...
      logout: function () {
        this.$confirm('确认退出吗?', '提示', {
          ...
          //跳转到统一登陆
          window.location = "http://ucenter.lxw.com/#/logout"
